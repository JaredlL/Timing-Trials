 ...
 *
 */
class AlternativeLayoutManager : RecyclerView.LayoutManager() {
    ...
    override fun onLayoutChildren(recycler: RecyclerView.Recycler, state: RecyclerView.State) {
        ...
        if (childCount == 0) { //First or empty layout
             ...
             * won't change.
             */
            mDecoratedChildWidth = 150 //getDecoratedMeasuredWidth(scrap)
            mDecoratedChildHeight = 80 //getDecoratedMeasuredHeight(scrap)
    ...
    override fun scrollToPosition(position: Int) {
        if (position >= itemCount) {
            Timber.e(TAG, "Cannot scroll to $position, item count is $itemCount")
            return
        }
    ...
    companion object {
        private val TAG = AlternativeLayoutManager::class.java.simpleName
